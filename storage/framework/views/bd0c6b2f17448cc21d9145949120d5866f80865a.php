		...
		<div class="cont_centrar">
			...
			<div class="cont_login">
				...
				<div class="cont_forms" >
					...
					<form method="post" action="<?php echo e(url('absensi/datang')); ?>" enctype="multipart/form-data">
					...
					<form method="post" action="<?php echo e(url('absensi/pulang')); ?>" enctype="multipart/form-data">
...
<script src="http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.4/jquery.js"></script>
 ...
 <script>
 	<?php if(Session::get('msg') == 'not-found'): ?>
	...
	<?php elseif(Session::get('msg') == 'sudah-absen'): ?>
	$(document).ready(function() {
	       swal(
	     'Ooops!',
	...
	<?php elseif(Session::get('msg') == 'belum-absen-kedatangan'): ?>
	$(document).ready(function() {
	       swal(
	     'Ooops!',
	...
	<?php elseif(Session::get('msg') == 'sukses-absen'): ?>
	$(document).ready(function() {
	       swal(
	     'Yeay!',
