...
<!--             <li
            ...
            <?php endif; ?>
            >
                <a href="<?php echo e(url('shops')); ?>"><i class='fa fa-shopping-cart'></i> <span>Pelanggan</span></a>
            </li> 
            <li
            <?php if($page == 'kelola-pemberian-kredit'): ?>
            <?php echo 'class="active"'; ?>

            <?php endif; ?>
            >
                <a href="<?php echo e(url('kelola-pemberian-kredit')); ?>"><i class='fa fa-pencil'></i> <span>Kelola pemberian kredit</span></a>
            </li>
            <!-- <li
            <?php if($page == 'export'): ?>
            <?php echo 'class="active"'; ?>
